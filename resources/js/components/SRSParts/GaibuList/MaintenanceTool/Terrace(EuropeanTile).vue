...
export default {
  ...
  async mounted(){
      ...
      try {
        const data = await axios.get('api/terasu');
      ...
      try{
        ...
        this.datas = data.data.data.filter(Id => Id.Id == 28);  //NEED TO CHANGE ACCORDING TO ID
  ...
  methods:{
    ...
    async Save(){
     ...
     // ==========================for i-smart==============================
      ...
      data_array.push( 28, this.SmileExcludedItems, this.SmartExcludedItems, this.CubeExcludedItems, this.PalleteExcludedItems, SmileDefault, SmartDefault, CubeDefault, PalleteDefault, this.houseTypes);
