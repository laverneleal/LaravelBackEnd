...
export default {
  ...
  async mounted(){
      ...
      try {
        const data = await axios.get('api/mizukiri');
      ...
      try{
        ...
        this.datas = data.data.data.filter(Id => Id.Id == 9);  //NEED TO CHANGE ACCORDING TO ID
  ...
  methods:{
    ...
    async Save(){
     ...
     // ==========================for i-smart==============================
      ...
      data_array.push( 9, this.SmileExcludedItems, this.SmartExcludedItems, this.CubeExcludedItems, this.PalleteExcludedItems, SmileDefault, SmartDefault, CubeDefault, PalleteDefault, this.houseTypes);
