...
export default {
  ...
  async mounted(){
      ...
      try {
        const data = await axios.get('api/balconyTesuri2/5');
      ...
      try{
        ...
        this.datas = data.data.data.filter(Id => Id.Id == 32);  //NEED TO CHANGE ACCORDING TO ID
  ...
  methods:{
    ...
    async Save(){
      ...
      try {
        const data = await axios.get('api/balconyTesuri3/5');
        this.texturesInAPI = data.data.data;
      }catch(error){
        console.log(error);
      }
     ...
     // ==========================for i-smart==============================
      ...
      data_array.push( 32, this.SmileExcludedItems, this.SmartExcludedItems, this.CubeExcludedItems, this.PalleteExcludedItems, SmileDefault, SmartDefault, CubeDefault, PalleteDefault, this.houseTypes);
