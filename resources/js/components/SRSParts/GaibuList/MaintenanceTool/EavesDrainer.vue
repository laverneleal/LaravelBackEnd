              ...
              <tr> 
                <td class="firstColumnWidth" :rowspan="$PlanData.texturesInAPI($PlanData.itemIndex('0')).length" >
                  <v-checkbox 
                      ...
                      label="i-Smile" 
                      :value="0"
                      @click="visibleSmile = !visibleSmile; SmileTextures(visibleSmile)"
                  /> 
                </td>
              ...
              <tr> 
                <td class="firstColumnWidth" :rowspan="$PlanData.texturesInAPI($PlanData.itemIndex('0')).length" >
                  <v-checkbox 
                      ...
                      label="i-Smart" 
                      :value="1"
                      @click="visibleSmart = !visibleSmart; SmartTextures(visibleSmart)"
                  /> 
                </td>
              ...
              <tr> 
                <td class="firstColumnWidth" :rowspan="$PlanData.texturesInAPI($PlanData.itemIndex('0')).length + 1" >
                  <v-checkbox 
                      ...
                      label="i-Cube" 
                      :value="2"
                      @click="visibleCube = !visibleCube; CubeTextures(visibleCube)"
                  /> 
                </td>
              ...
              <tr> 
                <td class="firstColumnWidth" :rowspan="$PlanData.texturesInAPI($PlanData.itemIndex('0')).length + 1" >
                  <v-checkbox 
                      ...
                      label="i-Pallete" 
                      :value="3"
                      @click="visiblePallete = !visiblePallete; PalleteTextures(visiblePallete)"
                  /> 
                </td>
...
export default {
  ...
  async mounted(){
      ...
      try {
        const data = await axios.get('api/roofCeiling');
      ...
      try{
        ...
        this.datas = data.data.data.filter(Id => Id.Id == 5);  //NEED TO CHANGE ACCORDING TO ID
  ...
  methods:{
    ...
    async Save(){
     ...
     // ==========================for i-smart==============================
      ...
      data_array.push( 5, this.SmileExcludedItems, this.SmartExcludedItems, this.CubeExcludedItems, this.PalleteExcludedItems, SmileDefault, SmartDefault, CubeDefault, PalleteDefault, this.houseTypes);
