...
export default {
  ...
  async mounted(){
      ...
      try {
        const data = await axios.get('api/porch');
      ...
      try{
        ...
        this.datas = data.data.data.filter(Id => Id.Id == 18);  //NEED TO CHANGE ACCORDING TO ID
  ...
  methods:{
    ...
    async Save(){
     ...
     // ==========================for i-smart==============================
      ...
      data_array.push( 18, this.SmileExcludedItems, this.SmartExcludedItems, this.CubeExcludedItems, this.PalleteExcludedItems, SmileDefault, SmartDefault, CubeDefault, PalleteDefault, this.houseTypes);
