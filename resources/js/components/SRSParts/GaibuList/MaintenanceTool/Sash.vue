...
export default {
  ...
  async mounted(){
      ...
      try {
        const data = await axios.get('api/sash');
      ...
      try{
        ...
        this.datas = data.data.data.filter(Id => Id.Id == 11);  //NEED TO CHANGE ACCORDING TO ID
  ...
  methods:{
    ...
    async Save(){
     ...
     // ==========================for i-smart==============================
      ...
      data_array.push( 11, this.SmileExcludedItems, this.SmartExcludedItems, this.CubeExcludedItems, this.PalleteExcludedItems, SmileDefault, SmartDefault, CubeDefault, PalleteDefault, this.houseTypes);
