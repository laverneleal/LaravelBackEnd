             ...
             <!--===================== I-SMILE ========================-->
              ...
              <template v-if="visibleSmile">
                ...
                <tr v-if="($PlanData.itemIndexTexture(texturesInAPI, texture.SortNo) == 0)">  
                    <td class="firstColumnWidth" :rowspan="texturesInAPI.length" >
                    <v-checkbox 
                        class="shrink mr-0 mt-0" 
                        v-model="houseTypes" 
                        color="orange" 
...
export default {
  ...
  async mounted(){
      ...
      try {
        const data = await axios.get('api/balconyCeiling');
      ...
      try{
        ...
        this.datas = data.data.data.filter(Id => Id.Id == 4);  //NEED TO CHANGE ACCORDING TO ID
  ...
  methods:{
    ...
    async Save(){
     ...
     // ==========================for i-smart==============================
      ...
      data_array.push( 4, this.SmileExcludedItems, this.SmartExcludedItems, this.CubeExcludedItems, this.PalleteExcludedItems, SmileDefault, SmartDefault, CubeDefault, PalleteDefault, this.houseTypes);
