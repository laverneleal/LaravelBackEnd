        ...
        <v-card-text class="headline">
          ...
          <v-simple-table width="100%" class="grey lighten-5" >
            ...
            <tbody>
              ...
              <!--======ヨーロピアンタイル========-->
              <template v-for="texture in texturesInAPI">  
...
export default {
  ...
  async mounted(){
      ...
      try {
        const data = await axios.get('api/genkanDomaTeracotta2');
      ...
      try{
        ...
        this.datas = data.data.data.filter(Id => Id.Id == 77);  //NEED TO CHANGE ACCORDING TO ID
  ...
  methods:{
    ...
    async Save(){
     ...
     // ==========================for i-smart==============================
      ...
      data_array.push( 77, this.SmileExcludedItems, this.SmartExcludedItems, this.CubeExcludedItems, this.PalleteExcludedItems, SmileDefault, SmartDefault, CubeDefault, PalleteDefault, this.houseTypes);
