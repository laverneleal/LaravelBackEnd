<template>
  ...
  <v-simple-table class="tg" width="100%">
    <tr> 
      <td width="38px" :rowspan="texturesInAPI.length + 3" class="borderRight"><center><v-icon @click="addPorch()" :color="visibleIcon.color">{{this.visibleIcon.icon}}</v-icon></center></td>
